...
def competence_exp_tree(target, reached, dist_min=0., dist_max=10., power=1.):
    return competence_exp(target, reached, dist_min, dist_max,power)


tree_config = {'default': {'max_points_per_region': 100,
                                                        'max_depth': 20,
                                                       'split_mode': 'best_interest_diff',
                                                       'competence_measure': competence_exp_tree,
...
######################################
    ...
    if True:
        ...
        sampling_mode =tree_config['default']['sampling_mode']
